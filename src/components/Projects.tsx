  ...
  const projects = [
    {
      ...
      description: "Digital twin 3D monitoring system for water distribution implemented at Urbansolv. Developed backend for process indicators and integration with 3D visualization for real-time monitoring.",
    ...
    },
    {
      ...
      description: "3D digital twin monitoring system for water distribution. Developed process indicators and integrated them with 3D visualization for real-time monitoring and analysis.",
    ...
    },
    {
      ...
      description: "Smart building system with machine learning implementation for prediction and optimization. Conducted ML model training and developed API integration with monitoring systems.",
